...
class YGtPM:
    ...
    def dclean(self, uniprot_mod_raw):  
        ...
        with open('domains.txt', 'w') as domain:
            with open(uniprot_mod_raw) as raw:
                for a in raw:
                    if not a.startswith('##'):
                        a = a.split('=')
                        a1 = a[0].split()
                        if a1[2] == 'Domain':
                            if len(a) == 2:
                                a2 = a[1].rstrip()
                                domain.write(a1[0]+'\t'+a1[3]+'\t'+a1[4]+'\t'+a2+'\n')
                                continue
                            if len(a) == 4:
                                a3 = a[1].rstrip().split(';')
                                a4 = a[3].rstrip().split('|')
                            if len(a4) > 1:
                                domain.write(a1[0]+'\t'+a1[3]+'\t'+a1[4]+'\t'+a3[0]+'\t'+a4[1]+'\n')
                            if len(a4) ==1:
                                domain.write(a1[0]+'\t'+a1[3]+'\t'+a1[4]+'\t'+a4[0]+'\n')
                    ...
                    with open(domain,'r') as dp:
                        for d in dp:
                            ...
                            if len(f) > 2 and f[0] == d[0]:
                                if len(d) == 4:
                                    id_domain.write(d[0]+'\t'+f[1]+'\t'+f[2]+'\t'+d[1]+'\t'+d[2]+'\t'+d[3]+'\n')
                                if len(d) == 5:
                                    id_domain.write(d[0]+'\t'+f[1]+'\t'+f[2]+'\t'+d[1]+'\t'+d[2]+'\t'+d[3]+'\t'+d[4]+'\n')
                                if len(d) == 6:
                                    id_domain.write(d[0]+'\t'+f[1]+'\t'+f[2]+'\t'+d[1]+'\t'+d[2]+'\t'+d[3]+'\t'+d[4]+'\t'+d[5]+'\n')
                                if len(d) == 7:
                                    id_domain.write(d[0]+'\t'+f[1]+'\t'+f[2]+'\t'+d[1]+'\t'+d[2]+'\t'+d[3]+'\t'+d[4]+'\t'+d[5]+'\t'+d[6]+'\n')
                                if len(d) == 8:
                                    id_domain.write(d[0]+'\t'+f[1]+'\t'+f[2]+'\t'+d[1]+'\t'+d[2]+'\t'+d[3]+'\t'+d[4]+'\t'+d[5]+'\t'+d[6]+'\t'+d[7]+'\n')
                            ...
                            for line2 in f2:
                                ...
                                if line1[0] == line2[2]:
                                    if int(line1[1]) >= int(line2[3]) and int(line1[1]) <= int(line2[4]):
                                        if len(line2) == 6:
                                            mp.write(line2[0]+'\t'+line1[0]+'\t'+line2[3]+'\t'+line1[1]+'\t'+line2[4]+'\t'+line2[5]+'\t'+'UniProt'+'\n')
                                            summary.write(line2[0]+'\t'+line1[0]+'\t'+line1[1]+'\t'+line2[5]+'\t'+'domain'+'\t'+'UniProt'+'\n')
                                        if  len(line2) == 7:
                                            mp.write(line2[0]+'\t'+line1[0]+'\t'+line2[3]+'\t'+line1[1]+'\t'+line2[4]+'\t'+line2[5]+'\t'+line2[6]+'UniProt'+'\n')
                                            summary.write(line2[0]+'\t'+line1[0]+'\t'+line1[1]+'\t'+line2[5]+'\t'+line2[6]+'domain'+'\t'+'UniProt'+'\n')
                                        if  len(line2) == 8:
                                            mp.write(line2[0]+'\t'+line1[0]+'\t'+line2[3]+'\t'+line1[1]+'\t'+line2[4]+'\t'+line2[5]+'\t'+line2[6]+'\t'+line2[7]+'UniProt'+'\n')
                                            summary.write(line2[0]+'\t'+line1[0]+'\t'+line1[1]+'\t'+line2[5]+'\t'+line2[6]+'\t'+line2[7]+'domain'+'\t'+'UniProt'+'\n')
                                        if  len(line2) == 9:
                                            mp.write(line2[0]+'\t'+line1[0]+'\t'+line2[3]+'\t'+line1[1]+'\t'+line2[4]+'\t'+line2[5]+'\t'+line2[6]+'\t'+line2[7]+'\t'+line2[8]+'UniProt'+'\n')
                                            summary.write(line2[0]+'\t'+line1[0]+'\t'+line1[1]+'\t'+line2[5]+'\t'+line2[6]+'\t'+line2[7]+'\t'+line2[8]+'domain'+'\t'+'UniProt'+'\n')
                                        if  len(line2) == 10:
                                            mp.write(line2[0]+'\t'+line1[0]+'\t'+line2[3]+'\t'+line1[1]+'\t'+line2[4]+'\t'+line2[5]+'\t'+line2[6]+'\t'+line2[7]+'\t'+line2[8]+'\t'+line2[9]+'UniProt'+'\n')
